...
@pytest.mark.parametrize(('file_name', 'line_number',
                          'description', 'result_string'), [
    pytest.param(None, None, None, '<UNKNOWN>', id='nothing'),
    pytest.param('/tmp/foo', None, '!extra!',
                 '/tmp/foo "!extra!"', id='file_name, extra'),
    pytest.param('/tmp/foo', None, None, '/tmp/foo',
                 id='file_name'),
    pytest.param('/tmp/foo', 1, None, '/tmp/foo:1',
                 id='file_name, line_number=1'),
    pytest.param('/tmp/foo', 42, None, '/tmp/foo:42',
                 id='file_name, line_number=42'),
    pytest.param('/tmp/foo', 1, '!extra!', '/tmp/foo:1 "!extra!"',
                 id='file_name, line_number=1, extra'),
    pytest.param('/tmp/foo', 42, '!extra!', '/tmp/foo:42 "!extra!"',
...
@pytest.mark.parametrize(('file_name', 'line_number', 'description'), [
    pytest.param(None, 42,  None, id='line_number'),
    pytest.param('/tmp/foo', 0, None,
                 id='file_name, invalid line_number'),
    pytest.param('/tmp/foo', -1, None,
                 id='file_name, invalid line_number 2'),
    pytest.param(None, 42, '!extra!',
                 id='line_number, extra'),
])
