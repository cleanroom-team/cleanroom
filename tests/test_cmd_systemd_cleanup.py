...
import cleanroom.generator.commands.systemd_cleanup as systemd_cleanup


@pytest.mark.parametrize(('test_input', 'expected'), [
    pytest.param(('/etc/systemd/system/', '/usr/lib/systemd/system/',
    ...
    pytest.param(('/etc/systemd/system/', '/usr/lib/systemd/system/',
                 ...
                 ('/tmp/test', '/tmp/test'),
                 id='elsewhere'),
    pytest.param(('/foo/bar/', '/foo/baz/bar/', '/foo/bar/baz/test'),
...
@pytest.mark.parametrize(('test_input', 'expected'), [
    ...
    pytest.param(('/etc/systemd/system/', '/usr/lib/systemd/system/',
                 ...
                 ('/usr/lib/systemd/system/baz.wants/foo.service',
                  '../bar.service'),
                 id='to parent dir'),
    pytest.param(('/etc/systemd/system/',
    ...
    pytest.param(('/etc/systemd/system/', '/usr/lib/systemd/system/',
                  '/etc/systemd/system/baz.wants/foo.service', '/dev/null'),
                 ('/usr/lib/systemd/system/baz.wants/foo.service',
                  '/dev/null'),
                 id='to /dev/null'),
    pytest.param(('/etc/systemd/system/', '/usr/lib/systemd/system/',
...
# _map_host_link:
@pytest.mark.parametrize(('test_input', 'expected'), [
    pytest.param(('/tmp/foo/', '/tmp/foo/etc/systemd/system/',
