...
def test_file_mapping(system_context: SystemContext,
                      input_file: str, result_file: str) -> None:
...
def test_file_mapping_outside(system_context: SystemContext,
                              input_file: str, result_file: str) -> None:
...
def test_file_mapping_errors(system_context: SystemContext,
                             input_file: str) -> None:
...
def test_file_with_extension_to_dir_copy(populated_system_context: SystemContext) -> None:
    fs = populated_system_context.fs_directory
