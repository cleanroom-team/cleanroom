...
class SshInstallPrivateKeyCommand(cmd.Command):
    ...
    def __call__(self, location, system_context, *args, **kwargs):
        ...
        system_context.execute(location, 'copy', keyfile,
                               ssh_directory, from_outside=True)
        file.chown(system_context, user_data.uid, user_data.gid, keyfile)
        file.chmod(system_context, 0o600, keyfile)
