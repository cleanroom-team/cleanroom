# -*- coding: utf-8 -*-
"""_clr_icon_cache_update_trigger command.
...
class ClrIconCacheUpdateTriggerCommand(Command):
    """The _clr_icon_cache_update_trigger command."""

    def __init__(self, **services: typing.Any) -> None:
        """Constructor."""
        super().__init__(
            "_clr_icon_cache_update_trigger",
            help_string="Update icon cache.",
            file=__file__,
            **services,
        )
    ...
    def __call__(
        ...
        **kwargs: typing.Any,
        ...
        if not os.path.exists(
            ...
            system_context.file_name("/usr/bin/icon-cache-update.sh")
        ):
            return
