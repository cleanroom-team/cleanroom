...
class _TeardownCommand(Command):
    ...
    def __call__(self, location: Location, system_context: SystemContext,
        ...
        debug('Cleaning up everything in "{}".'.format(system_context.scratch_directory))
        self._service('btrfs_helper').delete_subvolume_recursive(system_context.scratch_directory)
