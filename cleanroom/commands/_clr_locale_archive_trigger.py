# -*- coding: utf-8 -*-
"""_clr_locale_archive_trigger command.
...
class ClrLocaleArchiveTriggerCommand(Command):
    """The _clr_locale_archive_trigger command."""
    ...
    def __call__(
        ...
        **kwargs: typing.Any,
        ...
        ) or not os.path.isfile(system_context.file_name("/usr/bin/localedef")):
            return
