    ...
    *,
    ...
    with disk.NbdDevice.new_image_file(
        ...
        with mount.Mount(
            ...
            extracted_image = os.path.join(
                data_dir, ".images", "clrm_{}".format(extracted_version)
            )
...
class QemuInstallTarget(InstallTarget):
    def __init__(self) -> None:
        super().__init__("qemu", "Set up hdd image and start it in qemu")
